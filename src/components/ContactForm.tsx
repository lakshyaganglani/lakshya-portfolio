  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
      ...
      <button
        ...
        className="rounded-md bg-signal px-5 py-2.5 text-sm font-semibold text-bg hover:bg-signal-dim transition-colors disabled:opacity-80 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
        {status === "submitting" && (
          <svg
